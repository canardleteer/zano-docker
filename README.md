...
# To build Zano 2.1.7.424 with all processors on your system.
docker build \
    --build-arg ZANO_REF="2.1.7.424" \
    --build-arg BUILD_WIDTH=$(nproc) \
    -t zano-runner:latest .

# To build a distroless zanod from Zano 2.1.7.424 with all processors on
# your system.
docker build \
    --build-arg ZANO_REF="2.1.7.424" \
    --build-arg BUILD_WIDTH=$(nproc) \
...
# To build a distroless simplewallet from Zano 2.1.7.424 with all processors
# on your system.
docker build \
    --build-arg ZANO_REF="2.1.7.424" \
    --build-arg BUILD_WIDTH=$(nproc) \
